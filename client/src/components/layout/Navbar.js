                    ...
                    <div className="flex items-center md:order-2">
                        ...
                        <div className={`${usertoggle ? "block z-50 overflow-auto absolute" : "hidden"}  float-right  lg:w-48 md:w-44 mt-72 -ml-20 md:-ml-40 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600`}>
                            ...
                            <ul className="py-2" aria-labelledby="user-menu-button">
                                ...
                                <li>
                                    <Link to="/" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Register</Link>
                                </li>
                                <li>
                                    <Link to="/" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Logins</Link>
                                </li>
